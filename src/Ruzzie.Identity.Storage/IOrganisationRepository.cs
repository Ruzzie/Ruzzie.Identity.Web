...
public interface IOrganisationRepository<TOrganisation, out TUserOrg, out TOrgUser, TOrgInvite>
    where TUserOrg : IUserOrgProps where TOrgUser : IUserOrgProps
{
    ...
    void AddUserToOrganisation(string         userId
