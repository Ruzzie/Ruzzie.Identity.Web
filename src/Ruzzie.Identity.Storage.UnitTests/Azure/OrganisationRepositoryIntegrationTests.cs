...
namespace Ruzzie.Identity.Storage.UnitTests.Azure
{
    ...
    public class OrganisationRepositoryIntegrationTests
    {
        ...
        public void FixtureSetup()
        {
            ...
            _testTableName = nameof(OrganisationRepositoryIntegrationTests);
            var cloudStorageAccount = CloudStorageAccount.Parse(connString);
            _repository = new OrganisationRepository(
                new CloudTablePool(_testTableName, cloudStorageAccount),
                new CloudTablePool(_testTableName + "userOrg", cloudStorageAccount),
                new CloudTablePool(_testTableName + "orgUser", cloudStorageAccount),
                new CloudTablePool(_testTableName + "Invites", cloudStorageAccount)
            );
        }

        private static string CreateUniqueOrganisationNameForTest(string testName)
        {
        ...
        {
            //Act & Assert
            _repository.OrganisationExists(CreateUniqueOrganisationNameForTest(nameof(OrgDoesntExistsSmokeTest))).Should().BeFalse();
        }
        ...
        public void InsertOrgAndCheckIfExists()
        {
            ...
            _repository.OrganisationExists(orgName).Should().BeFalse();

            //Act
            var insertedEntity = _repository.InsertNewOrganisation(entityToInsert);

            //Assert
            _repository.OrganisationExists(orgName).Should().BeTrue();
        ...
        public void GetOrgByIdThatExistsSmokeTest()
        {
            ...
            //Act
            var gotEntity = _repository.GetOrganisationById(orgName.CreateAlphaNumericKey(
        ...
        public void UpdateOrgSmokeTest()
        {
            ...
            var entity = _repository.InsertNewOrganisation(entityToInsert);
            ...
            //Act
            var updatedEntity = _repository.UpdateOrganisation(entity);
        ...
        public void AddUserToOrgSmokeTest()
        {
            ...
            //Act
            _repository.AddUserToOrganisation(userId, entity.RowKey, "Default", DateTimeOffset.UtcNow);

            //Assert
            _repository.GetOrganisationsForUser(userId).Should().HaveCount(1);
            _repository.GetUsersForOrganisation(entity.RowKey).Should().HaveCount(1);
        }
        ...
        public void UserIsInOrganisationSmokeTest()
        {
            ...
            //Act & Assert 1
            _repository.UserIsInOrganisation(entity.RowKey, userId).Should().BeFalse();

            //Arrange for 2
            _repository.AddUserToOrganisation(userId, entity.RowKey, "Default", DateTimeOffset.UtcNow);

            //Act & Assert 2
            _repository.UserIsInOrganisation(entity.RowKey, userId).Should().BeTrue();
        }
        ...
        public void UpsertOrganisationInvite_Insert_SmokeTest()
        {
            ...
            //Act
            var entity = _repository.UpsertOrganisationInvite(entityToInsert);
        ...
        public void UpsertOrganisationInvite_Update_SmokeTest()
        {
            ...
            //Act
            var updatedEntity = _repository.UpsertOrganisationInvite(entity);
        ...
        public void GetOrganisationInvite_SmokeTest()
        {
            ...
            //Act
            var retrievedEntity = _repository.GetOrganisationInvite(entity.PartitionKey, userId);
        ...
        public void GetAllOrganisationInvites_SmokeTest()
        {
            ...
            //Act
            var invites = _repository.GetAllOrganisationInvites(entity.OrganisationId ?? "error", 0);
        ...
        public void DeleteUserFromOrganisation_SmokeTest()
        {
            ...
            //Act
            _repository.DeleteUserFromOrganisation(userId, entity.RowKey);
        ...
        public void DeleteOrganisationInvite_SmokeTest()
        {
            ...
            //Act
            _repository.DeleteOrganisationInvite(entity.PartitionKey, entity.RowKey);

            //Assert
            _repository.GetAllOrganisationInvites(entity.PartitionKey, 0).Should().HaveCount(0);
        }
        ...
        public void DeleteOrganisation_SmokeTest()
        {
            ...
            //Act
            _repository.DeleteOrganisation(entity.RowKey);

            //Assert
            _repository.GetOrganisationsForUser(userId).Should().HaveCount(0);
            _repository.GetUsersForOrganisation(entity.RowKey).Should().HaveCount(0);
        }
    }
}